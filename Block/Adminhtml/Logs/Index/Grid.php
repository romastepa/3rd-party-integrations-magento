...
namespace Emarsys\Emarsys\Block\Adminhtml\Logs\Index;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("status", [
            ...
            'width' => '150',
            'type' => 'options',
            'renderer' => 'Emarsys\Emarsys\Block\Adminhtml\Logs\Index\Renderer\StatusColor',
            'options' => [
                'success' => 'success',
                'error' => 'error',
                'missed' => 'missed',
        ...
        $this->addColumn("id", [
            ...
            "align" => "left",
            "index" => "id",
            'renderer' => 'Emarsys\Emarsys\Block\Adminhtml\Logs\Index\Renderer\ViewButton',
            'width' => '150'
        ]);
